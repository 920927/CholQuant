...
@torch.no_grad()
def opt_sequential(model, dataloader, method, whitenq_n, dev):
    print('Starting ...')
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--method', type=str, default="gptq", choices=['gptq', 'q2n', 'whitenq']
    )
    parser.add_argument(
    ...
    if args.wbits < 16 and not args.nearest:
        tick = time.time()
        quantizers = opt_sequential(model, dataloader, method_name, args.whitenq_n, DEV)
